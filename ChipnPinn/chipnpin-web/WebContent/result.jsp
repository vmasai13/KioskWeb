	...
	<head>
		...
		<script type='text/javascript'>
		      ...
		      function drawChart() {
		        ...
		        data.addColumn('number', 'Sucess');
		        data.addColumn('number', 'Error311');
		        data.addColumn('number', 'Error310');
		        data.addColumn('number', 'Error100');
		        data.addColumn('number', 'Error110');
		        ...
		        '<c:forEach var="reportTrend" items="${jsonObject}">';
		        		...
		        		jsonResp.push( [new Date(${reportTrend.key}), ${reportTrend.value[0]},${reportTrend.value[1]},${reportTrend.value[2]},${reportTrend.value[3]}, ${reportTrend.value[4]},${reportTrend.value[5]} ]);
				'</c:forEach>';
		        ...
		        chart.draw(data, {
					...
					colors : [ 'green', '#DF7401', '#B40404', '#DF01D7', '#58ACFA', 'blue' ],
